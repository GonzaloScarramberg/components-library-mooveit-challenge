...
`,ye=o.default.div`
  ...
  top: 0.3rem;
  cursor: pointer;
`;var he=o.default("div").withConfig({displayName:"gsInputText___StyledDiv",componentId:"ytidob-0"})(["width:100%;display:flex;"]),be=function(r){var o=r.style,a=r.placeholder,i=r.maxLength,l=r.hasResetButton,u=r.fieldName,c=r.disabled,s=r.value,d=r.onChangeValue,f=ee(n.default.useState(!1),2),p=f[0],m=f[1];return n.default.createElement(Q,{theme:e.useContext(t.ThemeContext)},n.default.createElement(fe,{id:"gsInputText",onFocus:function(){return m(!0)},onBlur:function(){""===s&&m(!1)}},n.default.createElement(he,null,n.default.createElement(pe,{inputStyle:o,disabled:c,placeholder:p?a:"",maxLength:"0"!==i?i:"",value:s,type:"text",name:"gsInput",id:"gsInputText",autoComplete:"off",className:"input",onChange:function(e){d(e.target.value)}}),l&&""!==s&&!c&&n.default.createElement(ye,{"aria-hidden":"true",onClick:function(){d(""),m(!1)}},"X"),n.default.createElement(me,{htmlFor:"gsInputText",isFocused:p,inputStyle:o},u))))};be.propTypes={style:G.string,placeholder:G.string,maxLength:G.string,hasResetButton:G.bool,fieldName:G.string,disabled:G.bool,value:G.string,onChangeValue:G.func},be.defaultProps={style:"Bottom-Lined",placeholder:"Placeholder",maxLength:"0",hasResetButton:!1,fieldName:"Field",disabled:!1,value:"",onChangeValue:function(){}};var ge=o.default("div").withConfig({displayName:"gsInputNumber___StyledDiv",componentId:"sc-14z4ok-0"})(["width:100%;display:flex;"]),ve=o.default("input").withConfig({displayName:"gsInputNumber___StyledInput",componentId:"sc-14z4ok-1"})(["width:100%;"]),xe=function(r){var o=r.format,a=r.disabled,i=r.placeholder,l=r.value,u=r.onChangeValue;n.default.useEffect((function(){u("")}),[o]);return n.default.createElement(Q,{theme:e.useContext(t.ThemeContext)},n.default.createElement(ge,null,n.default.createElement(ve,{autoComplete:"off",className:"input",value:l,disabled:a,onChange:function(e){return function(e){u(e.target.value.replace(/\D/,""));var t=/(\d)(?=(\d{3})+$)/g;switch(o){case"grouped-commas":u(e.target.value.replaceAll(",","").replace(t,"$1,"));break;case"grouped-dots":u(e.target.value.replaceAll(".","").replace(t,"$1."))}}(e)},placeholder:i})))};xe.propTypes={format:G.string,disabled:G.bool,placeholder:G.string,value:G.string,onChangeValue:G.func},xe.defaultProps={format:"no-grouped",disabled:!1,placeholder:"Insert a number",value:"",onChangeValue:function(){}};var Se=o.default("div").withConfig({displayName:"gsSelectInputItem___StyledDiv",componentId:"r99hwb-0"})(["margin-right:",";"],(e=>e._css));const we=({name:e,isMultiSelect:t,updateCheckStatus:r})=>{const[o,a]=n.default.useState(!1);return n.default.useEffect((()=>{t||a(!1)})),n.default.createElement(le,{"aria-hidden":"true",onClick:()=>{r({Name:e,Checked:!o}),a(!o)}},n.default.createElement(Se,{_css:t&&"0.5rem"},t&&n.default.createElement("input",{className:"checkbox",type:"checkbox",checked:o&&t,"data-testid":`checkbox-${e}`})),n.default.createElement("div",null,n.default.createElement("span",null,e)))};we.propTypes={name:G.string.isRequired,isMultiSelect:G.bool.isRequired,updateCheckStatus:G.func.isRequired};const Ee=o.default.div`
  display: flex;
  width: 100%;
  flex-flow: wrap;
  row-gap: 5px;
...
`,Oe=o.default.div`
  ...
  font-size: 1rem;
  color: white;
`;var Ie=function(r){var o=r.isMultiSelect,a=r.isStyledItem,i=r.placeholder,l=r.options,u=r.value,c=r.maxHeight,s=r.onChangeValue,d=ee(n.default.useState(!1),2),f=d[0],p=d[1];return n.default.createElement(Q,{theme:e.useContext(t.ThemeContext)},n.default.createElement(Ee,null,n.default.createElement(Ce,{id:"gsSelectInputField",onClick:function(){return p(!f)},"aria-hidden":"true"},n.default.createElement(ke,{"data-testid":"gsSelectInputValues"},0!==u.length?a?u.map((function(e){return n.default.createElement(Oe,null,e)})):u.map((function(e){return e})).toString():"".concat(i)),n.default.createElement($e,null,"+")),n.default.createElement(ie,{maxHeight:c,visibility:f},l.map((function(e){return n.default.createElement(we,{key:e,name:e,isMultiSelect:o,updateCheckStatus:function(e){!function(e){var t=te(u);o?e.Checked?t.push(e.Name):t=t.filter((function(t){return t!==e.Name})):(t=[]).push(e.Name),s(t)}(e)}})})))))};Ie.propTypes={isMultiSelect:G.bool,isStyledItem:G.bool,placeholder:G.string,options:G.arrayOf(G.string),value:G.arrayOf(G.string),maxHeight:G.string,onChangeValue:G.func},Ie.defaultProps={isMultiSelect:!1,isStyledItem:!1,placeholder:"Select an option",options:[],value:[],maxHeight:"200",onChangeValue:function(){}},exports.GSAutocomplete=de,exports.GSButton=Z,exports.GSInputNumber=xe,exports.GSInputText=be,exports.GSSelectInput=Ie;
