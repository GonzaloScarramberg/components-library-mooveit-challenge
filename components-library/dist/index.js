...
`,fe=o.default.i`
  ...
  padding: 3px;
`,me=({description:e,optionSelected:t})=>n.default.createElement(pe,{"data-testid":e,onClick:()=>t(e),"aria-hidden":"true"},n.default.createElement("div",null,n.default.createElement("span",null,e)));me.propTypes={description:G.string.isRequired,optionSelected:G.func.isRequired};var ye=o.default("div").withConfig({displayName:"gsAutocomplete___StyledDiv",componentId:"nustq2-0"})(["width:100%;display:flex;"]),be=o.default(se).withConfig({displayName:"gsAutocomplete___StyledStylesAutocompleteInput",componentId:"nustq2-1"})(["width:100%;"]),he=function(r){var o=r.noResultsMessage,a=r.placeholder,i=r.disabled,l=r.maxHeight,u=r.options,c=r.value,s=r.onChangeValue,d=te(n.default.useState(!1),2),p=d[0],f=d[1],m=te(n.default.useState([]),2),y=m[0],b=m[1],h=function(e){var t=u.filter((function(t){return t.toUpperCase().startsWith(e.toUpperCase())}));b(t)};n.default.useEffect((function(){h(c)}),[c]);var g=function(e){s(e),h(e),f(!p)},v=function(){return 0===y.length?n.default.createElement(pe,null,o):y.map((function(e){return n.default.createElement(me,{key:e,description:e,optionSelected:g})}))},x=function(){return""!==c?n.default.createElement(v,null):u.map((function(e){return n.default.createElement(me,{key:e,description:e,optionSelected:g})}))};return n.default.createElement(ie,{theme:e.useContext(t.ThemeContext)},n.default.createElement(ue,null,n.default.createElement(ce,{"data-testid":"gsAutocompleteField",className:"gsAutocompleteField","aria-hidden":"true",onClick:function(){return!i&&f(!p)}},n.default.createElement(ye,null,n.default.createElement(be,{autoComplete:"off","data-testid":"autocompleteInput",placeholder:a,disabled:i,value:c,type:"text",name:"gsAutocompleteInputField",id:"gsAutocompleteInputField",className:"input",onChange:function(e){return function(e){f(!0),s(e)}(e.target.value)}}))),n.default.createElement(de,{visible:p,"data-testid":"gsAutocompleteItemsList",maxHeight:l},n.default.createElement(x,null))))};he.propTypes={noResultsMessage:G.string,placeholder:G.string,disabled:G.bool,maxHeight:G.string,options:G.arrayOf(G.string),value:G.string,onChangeValue:G.func},he.defaultProps={noResultsMessage:"No results",placeholder:"choose an option",disabled:!1,maxHeight:"200",options:[],value:"",onChangeValue:function(){}};const ge=o.default.div`
  display: flex;
  flex-direction: column;
  position: relative;
  border-radius: 4px;
...
`,Se=o.default.div`
  ...
  top: 0.3rem;
  cursor: pointer;
`;var we=o.default("div").withConfig({displayName:"gsInputText___StyledDiv",componentId:"ytidob-0"})(["width:100%;display:flex;"]),ke=function(r){var o=r.style,a=r.placeholder,i=r.maxLength,l=r.hasResetButton,u=r.fieldName,c=r.disabled,s=r.value,d=r.onChangeValue,p=te(n.default.useState(!1),2),f=p[0],m=p[1];return n.default.createElement(ie,{theme:e.useContext(t.ThemeContext)},n.default.createElement(ge,{id:"gsInputText",onFocus:function(){return m(!0)},onBlur:function(){""===s&&m(!1)}},n.default.createElement(we,null,n.default.createElement(ve,{inputStyle:o,disabled:c,placeholder:f?a:"",maxLength:"0"!==i?i:"",value:s,type:"text",name:"gsInput",autoComplete:"off",className:"input",onChange:function(e){d(e.target.value)}}),l&&""!==s&&!c&&n.default.createElement(Se,{"aria-hidden":"true",onClick:function(){d(""),m(!1)}},"X"),n.default.createElement(xe,{htmlFor:"gsInputText",isFocused:f,inputStyle:o},u))))};ke.propTypes={style:G.string,placeholder:G.string,maxLength:G.string,hasResetButton:G.bool,fieldName:G.string,disabled:G.bool,value:G.string,onChangeValue:G.func},ke.defaultProps={style:"Bottom-Lined",placeholder:"Placeholder",maxLength:"0",hasResetButton:!1,fieldName:"Field",disabled:!1,value:"",onChangeValue:function(){}};const Ee=o.default.div`
  width: 100%;
  display: flex;
  position: relative;
`,Oe=o.default.input`
...
`,$e=o.default.button`
  ...
  border-radius: 2px;
`;var je=function(r){var o=r.format,a=r.disabled,i=r.placeholder,l=r.value,u=r.onChangeValue,c=r.buttons;n.default.useEffect((function(){u("")}),[o]);var s=function(e){var t=e;t=t.toString().replace(/\D/,"");var r=/(\d)(?=(\d{3})+$)/g;switch(o){case"grouped-commas":t=t.replace(/,/g,"").replace(r,"$1,");break;case"grouped-dots":t=t.replace(/\./g,"").replace(r,"$1.")}u(t)},d=function(e,t,r){var n=e.toString().replace(/,/g,"").replace(/\./g,"");"sumOperator"===r?n=+n+ +t:n>0&&(n-=t),n<t&&(n=0),s(n)};return n.default.createElement(ie,{theme:e.useContext(t.ThemeContext)},n.default.createElement(Ee,null,n.default.createElement(Oe,{autoComplete:"off",className:"input",value:l,disabled:a,onChange:function(e){return s(e.target.value)},placeholder:i}),/^\d+$/.test(c)&&n.default.createElement(Ce,null,n.default.createElement($e,{name:"sumOperator",onClick:function(e){return d(l,c,e.target.name)},type:"button"},"+"),n.default.createElement($e,{name:"minusOperator",onClick:function(e){return d(l,c,e.target.name)},type:"button"},"-"))))};je.propTypes={format:G.string,disabled:G.bool,placeholder:G.string,value:G.string,onChangeValue:G.func,buttons:G.string},je.defaultProps={format:"no-grouped",disabled:!1,placeholder:"Insert a number",value:"",onChangeValue:function(){},buttons:""};var Pe=o.default("div").withConfig({displayName:"gsSelectInputItem___StyledDiv",componentId:"r99hwb-0"})(["margin-right:",";"],(e=>e._css));const Ie=({name:e,isMultiSelect:t,updateCheckStatus:r})=>{const[o,a]=n.default.useState(!1);return n.default.useEffect((()=>{t||a(!1)})),n.default.createElement(pe,{"aria-hidden":"true",onClick:()=>{r({Name:e,Checked:!o}),a(!o)}},n.default.createElement(Pe,{_css:t&&"0.5rem"},t&&n.default.createElement("input",{className:"checkbox",type:"checkbox",checked:o&&t,"data-testid":`checkbox-${e}`,readOnly:!0})),n.default.createElement("div",null,n.default.createElement("span",null,e)))};Ie.propTypes={name:G.string.isRequired,isMultiSelect:G.bool.isRequired,updateCheckStatus:G.func.isRequired};const Te=o.default.div`
  display: flex;
  width: 100%;
  flex-flow: wrap;
  row-gap: 5px;
...
`,Ae=o.default.div`
  ...
  font-size: 1rem;
  color: white;
`;var Me=o.default(fe).withConfig({displayName:"gsSelectInput___StyledArrow",componentId:"sc-1cogm6a-0"})(["transform:rotate(45deg);-webkit-transform:rotate(45deg);"]),Re=function(r){var o=r.isMultiSelect,a=r.isStyledItem,i=r.placeholder,l=r.options,u=r.value,c=r.maxHeight,s=r.disabled,d=r.onChangeValue,p=te(n.default.useState(!1),2),f=p[0],m=p[1];return n.default.createElement(ie,{theme:e.useContext(t.ThemeContext)},n.default.createElement(Te,null,n.default.createElement(Ne,{id:"gsSelectInputField",onClick:function(){return m(!f)},"aria-hidden":"true"},n.default.createElement(_e,{"data-testid":"gsSelectInputValues",disabled:s},0!==u.length?a?u.map((function(e){return n.default.createElement(Ae,null,e)})):u.map((function(e){return e})).toString():"".concat(i)),n.default.createElement(Fe,null,n.default.createElement(Me,null))),!s&&n.default.createElement(de,{maxHeight:c,visible:f},l.map((function(e){return n.default.createElement(Ie,{key:e,name:e,isMultiSelect:o,updateCheckStatus:function(e){!function(e){var t=re(u);o?e.Checked?t.push(e.Name):t=t.filter((function(t){return t!==e.Name})):(t=[]).push(e.Name),d(t)}(e)}})})))))};Re.propTypes={isMultiSelect:G.bool,isStyledItem:G.bool,placeholder:G.string,options:G.arrayOf(G.string),value:G.arrayOf(G.string),maxHeight:G.string,disabled:G.bool,onChangeValue:G.func},Re.defaultProps={isMultiSelect:!1,isStyledItem:!1,placeholder:"Select an option",options:[],value:[],maxHeight:"200",disabled:!1,onChangeValue:function(){}},exports.GSAutocomplete=he,exports.GSButton=le,exports.GSInputNumber=je,exports.GSInputText=ke,exports.GSSelectInput=Re,exports.Theme=ie;
