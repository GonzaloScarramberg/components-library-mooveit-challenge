...
`,se=r.div`
  ...
  color: #495057;
  font-weight: lighter;
`,ue=({description:t,optionSelected:r})=>e.createElement(se,{"data-testid":t,onClick:()=>r(t),"aria-hidden":"true"},e.createElement("div",null,e.createElement("span",null,t)));ue.propTypes={description:X.string.isRequired,optionSelected:X.func.isRequired};var pe=r("div").withConfig({displayName:"gsAutocomplete___StyledDiv",componentId:"nustq2-0"})(["width:100%;display:flex;"]),de=r(le).withConfig({displayName:"gsAutocomplete___StyledStylesAutocompleteInput",componentId:"nustq2-1"})(["width:100%;"]),fe=function(r){var n=r.noResultsMessage,o=r.placeholder,i=r.disabled,l=r.maxHeight,c=r.options,s=r.value,u=r.onChangeValue,p=te(e.useState(!1),2),d=p[0],f=p[1],m=te(e.useState([]),2),y=m[0],b=m[1],h=function(e){var t=c.filter((function(t){return t.toUpperCase().startsWith(e.toUpperCase())}));b(t)};e.useEffect((function(){h(s)}),[s]);var g=function(e){u(e),h(e),f(!d)},v=function(){return 0===y.length?e.createElement(se,null,n):y.map((function(t){return e.createElement(ue,{key:t,description:t,optionSelected:g})}))},x=function(){return""!==s?e.createElement(v,null):c.map((function(t){return e.createElement(ue,{key:t,description:t,optionSelected:g})}))};return e.createElement(Z,{theme:t(a)},e.createElement(ae,null,e.createElement(ie,{"data-testid":"gsAutocompleteField",className:"gsAutocompleteField","aria-hidden":"true",onClick:function(){return!i&&f(!d)}},e.createElement(pe,null,e.createElement(de,{autoComplete:"off","data-testid":"autocompleteInput",placeholder:o,disabled:i,value:s,type:"text",name:"gsAutocompleteInputField",id:"gsAutocompleteInputField",className:"input",onChange:function(e){return function(e){f(!0),u(e)}(e.target.value)}}))),e.createElement(ce,{visibility:d,"data-testid":"gsAutocompleteItemsList",maxHeight:l},e.createElement(x,null))))};fe.propTypes={noResultsMessage:X.string,placeholder:X.string,disabled:X.bool,maxHeight:X.string,options:X.arrayOf(X.string),value:X.string,onChangeValue:X.func},fe.defaultProps={noResultsMessage:"No results",placeholder:"choose an option",disabled:!1,maxHeight:"200",options:[],value:"",onChangeValue:function(){}};const me=r.div`
  display: flex;
  flex-direction: column;
  position: relative;
  border-radius: 4px;
...
`,he=r.div`
  ...
  top: 0.3rem;
  cursor: pointer;
`;var ge=r("div").withConfig({displayName:"gsInputText___StyledDiv",componentId:"ytidob-0"})(["width:100%;display:flex;"]),ve=function(r){var n=r.style,o=r.placeholder,i=r.maxLength,l=r.hasResetButton,c=r.fieldName,s=r.disabled,u=r.value,p=r.onChangeValue,d=te(e.useState(!1),2),f=d[0],m=d[1];return e.createElement(Z,{theme:t(a)},e.createElement(me,{id:"gsInputText",onFocus:function(){return m(!0)},onBlur:function(){""===u&&m(!1)}},e.createElement(ge,null,e.createElement(ye,{inputStyle:n,disabled:s,placeholder:f?o:"",maxLength:"0"!==i?i:"",value:u,type:"text",name:"gsInput",id:"gsInputText",autoComplete:"off",className:"input",onChange:function(e){p(e.target.value)}}),l&&""!==u&&!s&&e.createElement(he,{"aria-hidden":"true",onClick:function(){p(""),m(!1)}},"X"),e.createElement(be,{htmlFor:"gsInputText",isFocused:f,inputStyle:n},c))))};ve.propTypes={style:X.string,placeholder:X.string,maxLength:X.string,hasResetButton:X.bool,fieldName:X.string,disabled:X.bool,value:X.string,onChangeValue:X.func},ve.defaultProps={style:"Bottom-Lined",placeholder:"Placeholder",maxLength:"0",hasResetButton:!1,fieldName:"Field",disabled:!1,value:"",onChangeValue:function(){}};const xe=r.div`
  width: 100%;
  display: flex;
  position: relative;
`,Se=r.input`
...
`,Ee=r.button`
  ...
  border-radius: 2px;
`;var ke=function(r){var n=r.format,o=r.disabled,i=r.placeholder,l=r.value,c=r.onChangeValue,s=r.buttons;e.useEffect((function(){c("")}),[n]);var u=function(e){var t=e;t=t.toString().replace(/\D/,"");var r=/(\d)(?=(\d{3})+$)/g;switch(n){case"grouped-commas":t=t.replaceAll(",","").replace(r,"$1,");break;case"grouped-dots":t=t.replaceAll(".","").replace(r,"$1.")}c(t)},p=function(e,t,r){var n=e.toString().replaceAll(",","").replaceAll(".","");"sumOperator"===r?n=+n+ +t:n>0&&(n-=t),n<t&&(n=0),u(n)};return e.createElement(Z,{theme:t(a)},e.createElement(xe,null,e.createElement(Se,{autoComplete:"off",className:"input",value:l,disabled:o,onChange:function(e){return u(e.target.value)},placeholder:i}),/^\d+$/.test(s)&&e.createElement(we,null,e.createElement(Ee,{name:"sumOperator",onClick:function(e){return p(l,s,e.target.name)},type:"button"},"+"),e.createElement(Ee,{name:"minusOperator",onClick:function(e){return p(l,s,e.target.name)},type:"button"},"-"))))};ke.propTypes={format:X.string,disabled:X.bool,placeholder:X.string,value:X.string,onChangeValue:X.func,buttons:X.string},ke.defaultProps={format:"no-grouped",disabled:!1,placeholder:"Insert a number",value:"",onChangeValue:function(){},buttons:""};var $e=r("div").withConfig({displayName:"gsSelectInputItem___StyledDiv",componentId:"r99hwb-0"})(["margin-right:",";"],(e=>e._css));const Ce=({name:t,isMultiSelect:r,updateCheckStatus:n})=>{const[o,a]=e.useState(!1);return e.useEffect((()=>{r||a(!1)})),e.createElement(se,{"aria-hidden":"true",onClick:()=>{n({Name:t,Checked:!o}),a(!o)}},e.createElement($e,{_css:r&&"0.5rem"},r&&e.createElement("input",{className:"checkbox",type:"checkbox",checked:o&&r,"data-testid":`checkbox-${t}`})),e.createElement("div",null,e.createElement("span",null,t)))};Ce.propTypes={name:X.string.isRequired,isMultiSelect:X.bool.isRequired,updateCheckStatus:X.func.isRequired};const Oe=r.div`
  display: flex;
  width: 100%;
  flex-flow: wrap;
  row-gap: 5px;
...
`,je=r.div`
  ...
  font-size: 1rem;
  color: white;
`;var Ne=function(r){var n=r.isMultiSelect,o=r.isStyledItem,i=r.placeholder,l=r.options,c=r.value,s=r.maxHeight,u=r.disabled,p=r.onChangeValue,d=te(e.useState(!1),2),f=d[0],m=d[1];return e.createElement(Z,{theme:t(a)},e.createElement(Oe,null,e.createElement(Ie,{id:"gsSelectInputField",onClick:function(){return m(!f)},"aria-hidden":"true"},e.createElement(Te,{"data-testid":"gsSelectInputValues",disabled:u},0!==c.length?o?c.map((function(t){return e.createElement(je,null,t)})):c.map((function(e){return e})).toString():"".concat(i)),e.createElement(Pe,null,"+")),!u&&e.createElement(ce,{maxHeight:s,visibility:f},l.map((function(t){return e.createElement(Ce,{key:t,name:t,isMultiSelect:n,updateCheckStatus:function(e){!function(e){var t=re(c);n?e.Checked?t.push(e.Name):t=t.filter((function(t){return t!==e.Name})):(t=[]).push(e.Name),p(t)}(e)}})})))))};Ne.propTypes={isMultiSelect:X.bool,isStyledItem:X.bool,placeholder:X.string,options:X.arrayOf(X.string),value:X.arrayOf(X.string),maxHeight:X.string,disabled:X.bool,onChangeValue:X.func},Ne.defaultProps={isMultiSelect:!1,isStyledItem:!1,placeholder:"Select an option",options:[],value:[],maxHeight:"200",disabled:!1,onChangeValue:function(){}};export{fe as GSAutocomplete,ee as GSButton,ke as GSInputNumber,ve as GSInputText,Ne as GSSelectInput};
