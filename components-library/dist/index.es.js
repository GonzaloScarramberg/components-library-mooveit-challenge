...
`,se=({description:t,optionSelected:r})=>e.createElement(ce,{"data-testid":t,onClick:()=>r(t),"aria-hidden":"true"},e.createElement("div",null,e.createElement("span",null,t)));se.propTypes={description:X.string.isRequired,optionSelected:X.func.isRequired};var ue=function(r){var n=r.noResultsMessage,o=r.placeholder,i=r.disabled,l=r.maxHeight,c=r.options,s=r.value,u=r.onChangeValue,p=te(e.useState(!1),2),d=p[0],f=p[1],m=te(e.useState([]),2),y=m[0],h=m[1],b=function(e){var t=c.filter((function(t){return t.toUpperCase().startsWith(e.toUpperCase())}));h(t)};e.useEffect((function(){b(s)}),[s]);var g=function(e){u(e),b(e),f(!d)},v=function(){return 0===y.length?e.createElement(ce,null,n):y.map((function(t){return e.createElement(se,{key:t,description:t,optionSelected:g})}))},x=function(){return""!==s?e.createElement(v,null):c.map((function(t){return e.createElement(se,{key:t,description:t,optionSelected:g})}))};return e.createElement(Z,{theme:t(a)},e.createElement(ae,null,e.createElement(ie,{"data-testid":"gsAutocompleteField",className:"gsAutocompleteField","aria-hidden":"true",onClick:function(){return!i&&f(!d)}},e.createElement("div",{style:{width:"100%"}},e.createElement("input",{style:{width:"100%"},autoComplete:"off","data-testid":"autocompleteInput",placeholder:o,disabled:i,value:s,type:"text",name:"gsAutocompleteInputField",id:"gsAutocompleteInputField",className:"input",onChange:function(e){return function(e){f(!0),u(e)}(e.target.value)}}))),d&&e.createElement(le,{"data-testid":"gsAutocompleteItemsList",maxHeight:l},e.createElement(x,null))))};ue.propTypes={noResultsMessage:X.string,placeholder:X.string,disabled:X.bool,maxHeight:X.string,options:X.arrayOf(X.string),value:X.string,onChangeValue:X.func},ue.defaultProps={noResultsMessage:"No results",placeholder:"choose an option",disabled:!1,maxHeight:"200",options:[],value:"",onChangeValue:function(){}};const pe=r.div`
  display: flex;
  flex-direction: column;
  position: relative;
  border-radius: 4px;
...
`,me=r.div`
  ...
  top: 0.3rem;
  cursor: pointer;
`;var ye=function(r){var n=r.style,o=r.placeholder,i=r.maxLength,l=r.hasResetButton,c=r.fieldName,s=r.disabled,u=r.value,p=r.onChangeValue,d=te(e.useState(!1),2),f=d[0],m=d[1];return e.createElement(Z,{theme:t(a)},e.createElement(pe,{id:"gsInputText",onFocus:function(){return m(!0)},onBlur:function(){""===u&&m(!1)}},e.createElement("div",null,e.createElement(de,{inputStyle:n,disabled:s,placeholder:f?o:"",maxLength:"0"!==i?i:"",value:u,type:"text",name:"gsInput",id:"gsInputText",className:"input",onChange:function(e){p(e.target.value)}}),l&&""!==u&&!s&&e.createElement(me,{"aria-hidden":"true",onClick:function(){p(""),m(!1)}},"X"),e.createElement(fe,{htmlFor:"gsInputText",isFocused:f,inputStyle:n},c))))};ye.propTypes={style:X.string,placeholder:X.string,maxLength:X.string,hasResetButton:X.bool,fieldName:X.string,disabled:X.bool,value:X.string,onChangeValue:X.func},ye.defaultProps={style:"Bottom-Lined",placeholder:"Placeholder",maxLength:"0",hasResetButton:!1,fieldName:"Field",disabled:!1,value:"",onChangeValue:function(){}};var he=function(r){var n=r.format,o=r.disabled,i=r.placeholder,l=r.value,c=r.onChangeValue;e.useEffect((function(){c("")}),[n]);return e.createElement(Z,{theme:t(a)},e.createElement("input",{className:"input",value:l,disabled:o,onChange:function(e){return function(e){c(e.target.value.replace(/\D/,""));var t=/(\d)(?=(\d{3})+$)/g;switch(n){case"grouped-commas":c(e.target.value.replaceAll(",","").replace(t,"$1,"));break;case"grouped-dots":c(e.target.value.replaceAll(".","").replace(t,"$1."))}}(e)},placeholder:i}))};he.propTypes={format:X.string,disabled:X.bool,placeholder:X.string,value:X.string,onChangeValue:X.func},he.defaultProps={format:"no-grouped",disabled:!1,placeholder:"Insert a number",value:"",onChangeValue:function(){}};var be=r("div").withConfig({displayName:"gsSelectInputItem___StyledDiv",componentId:"r99hwb-0"})(["margin-right:",";"],(e=>e._css));const ge=({name:t,isMultiSelect:r,updateCheckStatus:n})=>{const[o,a]=e.useState(!1);return e.useEffect((()=>{r||a(!1)})),e.createElement(ce,{"aria-hidden":"true",onClick:()=>{n({Name:t,Checked:!o}),a(!o)}},e.createElement(be,{_css:r&&"0.5rem"},r&&e.createElement("input",{className:"checkbox",type:"checkbox",checked:o&&r,"data-testid":`checkbox-${t}`})),e.createElement("div",null,e.createElement("span",null,t)))};ge.propTypes={name:X.string.isRequired,isMultiSelect:X.bool.isRequired,updateCheckStatus:X.func.isRequired};const ve=r.div`
  display: flex;
  width: 100%;
  flex-flow: wrap;
  row-gap: 5px;
...
`,Ee=r.div`
  ...
  font-size: 1rem;
  color: white;
`;var ke=function(r){var n=r.isMultiSelect,o=r.isStyledItem,i=r.placeholder,l=r.options,c=r.value,s=r.maxHeight,u=r.onChangeValue,p=te(e.useState(!1),2),d=p[0],f=p[1];return e.createElement(Z,{theme:t(a)},e.createElement(ve,null,e.createElement(xe,{id:"gsSelectInputField",onClick:function(){return f(!d)},"aria-hidden":"true"},e.createElement(Se,{"data-testid":"gsSelectInputValues"},0!==c.length?o?c.map((function(t){return e.createElement(Ee,null,t)})):c.map((function(e){return e})).toString():"".concat(i)),e.createElement(we,null,"+")),d&&e.createElement(le,{maxHeight:s},l.map((function(t){return e.createElement(ge,{key:t,name:t,isMultiSelect:n,updateCheckStatus:function(e){!function(e){var t=re(c);n?e.Checked?t.push(e.Name):t=t.filter((function(t){return t!==e.Name})):(t=[]).push(e.Name),u(t)}(e)}})})))))};ke.propTypes={isMultiSelect:X.bool,isStyledItem:X.bool,placeholder:X.string,options:X.arrayOf(X.string),value:X.arrayOf(X.string),maxHeight:X.string,onChangeValue:X.func},ke.defaultProps={isMultiSelect:!1,isStyledItem:!1,placeholder:"Select an option",options:[],value:[],maxHeight:"200",onChangeValue:function(){}};export{ue as GSAutocomplete,ee as GSButton,he as GSInputNumber,ye as GSInputText,ke as GSSelectInput};
